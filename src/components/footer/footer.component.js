const Footer = () => {
	return (
		<div className="mt-24 bg-white shadow-[0_-5px_20px_rgba(0,0,0,0.25)]">
			<div className="max-w-6xl px-10 mx-auto">
              ...
              <div className="flex flex-row space-x-3">
                ...
                <img className="h-8 object-contain hover:scale-105 duration-500" src="redbubbleLogo.png" alt="redbubble" />
					...
					<div className="flex flex-row justify-center w-full border1 h-full text-gray-600">
						<div className="flex flex-col space-y-1 items-center justify-center w-full border1 h-full text-gray-600 ">
